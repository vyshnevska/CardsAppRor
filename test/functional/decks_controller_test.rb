...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { cards: @deck.cards, count: @deck.count, players: @deck.players, trump: @deck.trump }
    end
  ...
  test "should update deck" do
    put :update, id: @deck, deck: { cards: @deck.cards, count: @deck.count, players: @deck.players, trump: @deck.trump }
    assert_redirected_to deck_path(assigns(:deck))
  end
